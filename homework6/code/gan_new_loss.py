...
def generator_loss(output, true_label):
    return torch.sum(torch.log(true_label - output)) / torch.sum(true_label) #np.sum(np.log(1 - output))
...
for epoch in range(epochs):
    ...
    save_generator_image(generated_img, f"homework6/data/output/new_loss_gen_img{epoch+1}.png")
...
print('DONE TRAINING')
torch.save(generator.state_dict(), 'homework6/data/output/new_loss_generator.pth')

# save the generated images as GIF file
imgs = [np.array(to_pil_image(img)) for img in images]
imageio.mimsave('homework6/data/output/new_loss_generator_images.gif', imgs)
...
plt.legend()
plt.savefig('homework6/data/output/new_loss_loss.png')
