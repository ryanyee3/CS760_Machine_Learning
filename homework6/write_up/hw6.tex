	...
	\begin{enumerate} [label=(\alph*)]
		...
		\begin{soln}
			...
			\begin{figure}[H]
				...
				\begin{subfigure}[b]{0.3\textwidth}
					\centering
					\includegraphics[width=\textwidth]{../figs/gen_img100.png}
					\caption{epoch 100}
				\end{subfigure}
				\caption{Generated images by $G$}
				\label{fig:q1_images}
		...
		\begin{soln}
			...
			\begin{figure}[H]
				...
				\begin{subfigure}[b]{0.3\textwidth}
					\centering
					\includegraphics[width=\textwidth]{../figs/new_loss_gen_img100.png}
					\caption{epoch 100}
				\end{subfigure}
				\caption{Generated images by $G$}
				\label{fig:q2_images}
		...
		\begin{soln}
			Based on this \href{https://pytorch.org/tutorials/beginner/dcgan_faces_tutorial.html}{DCGAN PyTorch tutorial} we could specify the betas in our Adam optimizer to be (.5, .999) instead of the \href{https://pytorch.org/docs/stable/generated/torch.optim.Adam.html#torch.optim.Adam}{default} (.9, .999).
